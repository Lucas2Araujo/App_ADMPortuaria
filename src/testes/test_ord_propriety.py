...
class TestCalculoScore(unittest.TestCase):
    ...
    def test_navio_carga_comum(self):
        ...
        navio = self._criar_navio_com_cargas(
            "A-001", "Navio da Virginia", [("Minério de Ferro", "COMUM", 5000, False)]
        )
    ...
    def test_regra_anti_starvation_tempo_de_espera(self):
        ...
        navio = self._criar_navio_com_cargas(
            "A-005", "Esperançoso", [("Aço", "COMUM", 1000, False)], horas_espera=10
        )
    ...
    def test_comparacao_pior_vs_melhor_caso(self):
        ...
        navio_pior = self._criar_navio_com_cargas(
            "P-001", "Jangada do Zé", [("Areia", "COMUM", 10, False)]
        )
        score_pior = calcular_score(navio_pior)

        navio_melhor = self._criar_navio_com_cargas(
            "M-001",
            "Gigante dos Mares",
